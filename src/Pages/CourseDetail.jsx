    ...
    return (
        <div>
            ...
            <div className="course-detail-page">
                <button className='backbtn'><a href='/courses'>Back to Courses</a></button>
                <div className="course-content-wrapper">
                    <div className="course-details">
                        <div className="course-card">
                            <img src={selectedCourse.thumbnail} alt={selectedCourse.title} className="course-thumbnail1" />
                        ...
                        <div className="course-card">
                            <h3 >Included with the Course</h3>
                            <ul>
                                <li>{selectedCourse.includes.video}</li>
                                <li>{selectedCourse.includes.resources}</li>
                                <li>{selectedCourse.includes.access}</li>
                                <li>{selectedCourse.includes.lifetime}</li>
                                <li>{selectedCourse.includes.certificate}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    {isModalOpen && <BuyNowModal onClose={handleCloseModal} />}
                </div>
